-- Primero eliminamos todas las restricciones de clave foránea existentes
SET FOREIGN_KEY_CHECKS = 0;

-- Eliminamos la tabla appointments actual
DROP TABLE IF EXISTS `appointments`;

-- Creamos la tabla appointments desde cero con la estructura correcta
